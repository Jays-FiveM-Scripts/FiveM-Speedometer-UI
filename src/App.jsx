...
function App() {
  ...
  useEffect(() => {
    const handleWindowMessage = (event) => {
      ...
      switch (type) {
        case 'HIDE_CONTENT': setIsVisible(false); break;
        case 'SHOW_CONTENT': setIsVisible(true); break;
        case 'UPDATE_SPEED': setSpeed(payload.speed); break;
        default: break;
      }
    };
...
useEffect(() => {
  ...
  return (
    <div className='speedo_container'>
      ...
      >
      <svg className="speedo-circle" width="200" height="200" viewBox="0 0 200 200">
  <defs>
